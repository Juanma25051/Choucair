...
Feature:verify the correct operation of register
  ...
  Scenario Outline: Register in Utests
    ...
    Examples:
      ...
      |Pedro |benites  |ch17_pruebas123@gmail.com|May|30|number:2002|Samsung|Galaxy S6 Edge|Android 8.0 (Oreo)|Pruebatecnica123|Pruebatecnica123|Welcome to the world's largest community of freelance software testers!|